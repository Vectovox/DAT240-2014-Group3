...
import petrinet.diagram.expressions.PetrinetOCLFactory;
...
public class PetrinetVisualIDRegistry {
	 ...
	 * @generated
	 */
	private static final String DEBUG_KEY = "se.chalmers.cse.mde2014.petrinet.graphicalEditor.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case PlaceTokenCompartmentEditPart.VISUAL_ID:
			if (PetrinetPackage.eINSTANCE.getToken().isSuperTypeOf(
					domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case PlaceEditPart.VISUAL_ID:
			...
			if (PlaceTokenCompartmentEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
	 ...
	 * @generated
	 */
	private static boolean isArc_4001(Arc domainElement) {
		Object result = PetrinetOCLFactory.getExpression(0,
				PetrinetPackage.eINSTANCE.getArc(), null).evaluate(
				domainElement);
