...
import petrinet.diagram.edit.commands.ArcCreateCommand;
import petrinet.diagram.edit.commands.ArcReorientCommand;
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case PlaceTokenCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					switch (PetrinetVisualIDRegistry.getVisualID(cnode)) {
