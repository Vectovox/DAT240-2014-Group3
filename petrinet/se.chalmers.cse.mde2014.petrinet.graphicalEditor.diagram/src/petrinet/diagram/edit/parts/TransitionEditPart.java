...
import petrinet.diagram.edit.policies.TransitionItemSemanticEditPolicy;
...
public class TransitionEditPart extends ShapeNodeEditPart {
	...
	public class TransitionFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureTransitionLabel;
		...
		private void createContents() {
			...
			RectangleFigure transitionFigureInner0 = new RectangleFigure();

			transitionFigureInner0.setForegroundColor(ColorConstants.black);
			transitionFigureInner0.setBackgroundColor(ColorConstants.black);
			transitionFigureInner0.setPreferredSize(new Dimension(getMapMode()
					.DPtoLP(50), getMapMode().DPtoLP(10)));

			this.add(transitionFigureInner0);
			transitionFigureInner0.setLayoutManager(new CenterLayout());

			fFigureTransitionLabel = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTransitionLabel() {
