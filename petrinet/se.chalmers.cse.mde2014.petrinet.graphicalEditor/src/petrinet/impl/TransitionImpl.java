 ...
 * <ul>
 *   <li>{@link petrinet.impl.TransitionImpl#getSeconds <em>Seconds</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends NodeImpl implements Transition {
	...
	public EList<Double> getSeconds() {
		if (seconds == null) {
			seconds = new EDataTypeUniqueEList<Double>(Double.class, this, PetrinetPackage.TRANSITION__SECONDS);
		}
		return seconds;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetPackage.TRANSITION__SECONDS:
				return getSeconds();
		}
